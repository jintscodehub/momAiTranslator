  ...
  try {
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Generate a recipe for ${topic}. Include a title, list of ingredients, and step-by-step instructions. Format the response as JSON with keys: title, ingredients (array), and instructions (array).`,
        },
      ],
    });
